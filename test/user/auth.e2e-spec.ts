...
describe('Auth Module', () => {
  ...
  const newUserEmail = `User.${Date.now()}@nomadsoft.us`;
  ...
  describe('Registration', () => {
    ...
    describe('Confirm email', () => {
      it.skip('should successfully: /api/v1/auth/email/confirm (POST)', async () => {
        // Skip test when using external mail service (Resend)
        // This test requires a local maildev service to fetch emails
