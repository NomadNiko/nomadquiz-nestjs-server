...
describe('Users Module', () => {
  ...
  describe('Update', () => {
    let newUser;
    const newUserEmail = `user-first.${Date.now()}@nomadsoft.us`;
    const newUserChangedEmail = `user-first-changed.${Date.now()}@nomadsoft.us`;
  ...
  describe('Create', () => {
    const newUserByAdminEmail = `user-created-by-admin.${Date.now()}@nomadsoft.us`;
